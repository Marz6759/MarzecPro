...
public class MarzecPro_ac {
    public static final String TAG = "MarzecPro_ac";
    public static Proxy log;
    ...
    MarzecPro_ac(Context context, Handler commandThreadHandler) {
    ...
    public void startDebian() {
        ...
        command = new String("LANG=" + NativeHelper.getLANG() +
                " ./start-marzec.sh" + NativeHelper.getArgs()
    ...
    public void stopDebian() {
        ...
        command = new String(NativeHelper.app_bin + "/chroot "
                ...
                + NativeHelper.preStopScript + "\"; ./stop-marzec.sh "
    ...
    public void removeDebianSetup() {
        command = "./marzec-delete.sh " + NativeHelper.getArgs();
        commandThread = new CommandThread();
        commandThread.start();
    }
    ...
    class CommandThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                sh.waitFor();
                Log.i(MarzecPro.TAG, "Done!");
            } catch (Exception e) {
                Log.e(MarzecPro.TAG, "Error!!!", e);
            } finally {
                synchronized (MarzecPro_ac.this) {
                    commandThread = null;
                }
    ...
    class LogUpdate extends StreamThread.StreamUpdate {
        ...
        public void update(String val) {
            ...
            if (commandThreadHandler != null) {
                Message msg = commandThreadHandler.obtainMessage();
                msg.arg1 = MarzecPro_ac.LOG_UPDATE;
                commandThreadHandler.sendMessage(msg);
            }
        }
    }
